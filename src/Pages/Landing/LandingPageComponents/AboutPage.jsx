      ...
      <div className="row">
        ...
        <div className="col-md-6 col-sm-12 pt-5" style={{ padding: "30px", textAlign: "justify" }}>
          ...
          <h5>
            ...
            hands-on online tests starting with CUET (UG) 2022. It will provide mock tests/practice tests and live classes. This platform will help students to excel in competitive
            exams.
          </h5>

          <h3 className="main-color mt-5">How does BESST help students?</h3>
          <h5>
            BESST partners with teachers and faculties who have better experience of helping students to realise their full potential. It has a simulation platform wherein students
            can access notes by specialised teachers, guidance of previous year’s toppers, practice sessions, etc.{" "}
          </h5>
        </div>
      </div>
    </section>
