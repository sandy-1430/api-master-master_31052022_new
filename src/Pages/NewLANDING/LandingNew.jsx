...
//extra-data
import { fetchCurrentAffairs } from "./utilities/data";
...
import TipsGuide from "./LandingPageComponents/TipsGuide";
import Statistics from "./LandingPageComponents/Statistics";
import CourseUpdate from "./LandingPageComponents/CourseUpdate";
...
function Landing() {
  ...
  return (
    <section className="container-fluid bg-white" style={{ padding: 0 }}>
      <Header
      ...
      <Headline onRegisterClick={onRegisterClick} />
      <CourseUpdate />
      <Services />
      {/* <TipsGuide /> */}
      <Statistics />
      ...
      <button
        ...
        onClick={() => {
          console.log("Enter", navigator.share);
          if (navigator.share) {
            navigator
              .share({
        ...
        className="float-facebook float-share"
        target="_blank"
      >
  ...
  /* <div className="container">
        ...
        <div className="row flex-lg-row-reverse align-items-center g-5 pt-5">
          <div className="col-10 col-sm-8 col-lg-6">
            <img src={carousel1} className="d-block mx-lg-auto img-fluid" alt="Bootstrap Themes" loading="lazy" width="700" height="500" />
          </div>
